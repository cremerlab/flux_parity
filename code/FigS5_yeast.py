...
# Load the data 
mass_fracs = pd.read_csv('../data/supplement_figure_data/yeast_ribosomal_mass_fractions.csv')
elong = pd.read_csv('../data/supplement_figure_data/yeast_peptide_elongation_rates.csv')
...
plt.savefig('../figures/supplement_text/FigS5_yeast_plots.pdf')
