...
elong_rate = pd.read_csv('../data/main_figure_data/Fig4_ecoli_peptide_elongation_rates.csv')
...
plt.tight_layout()
plt.savefig('../figures/main_text/plots/Fig4_simple_model_comparison.pdf', bbox_inches='tight')
