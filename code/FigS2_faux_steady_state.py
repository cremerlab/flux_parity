...
plt.tight_layout()
plt.savefig('../figures/supplement_text/plots/FigS2_preculture_dynamics_plots.pdf', bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../figures/supplement_text/plots/FigS2_preculture_ribosome_content_data.pdf', bbox_inches='tight')
# %%
