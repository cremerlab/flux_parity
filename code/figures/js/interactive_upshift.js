...
let preshift_params = ppGppEquilibrate(gamma_max,
        nu_max_preshift,tau, Kd_TAA, Kd_TAA_star,
        kappa_max, phiO_preshift)
let postshift_params = ppGppEquilibrate(gamma_max,
        nu_max_postshift, tau, Kd_TAA, Kd_TAA_star,
        kappa_max, phiO_postshift)

// console.log(preshift_params)
...
let init_args = [gamma_max, nu_max_preshift, tau, Kd_TAA, Kd_TAA_star, kappa_max, phiO_preshift,  0, true];
...
init_args = [gamma_max, nu_max_postshift, tau, Kd_TAA, Kd_TAA_star, kappa_max, phiO_postshift, 0, true];
...
// Preshift dynamics
for (var i = 0; i < (preshiftNSteps + postshiftNSteps - 1); i++) {
