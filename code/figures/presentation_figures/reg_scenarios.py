...
for i in range(3):
    ax[i, 0].set_ylabel('$\phi_R$')
    ax[i, 2].set_ylabel('$\gamma\, /\, \gamma_{max}$')
    ax[i, 1].set_ylabel('$\lambda\, /\, \gamma_{max}$')
...
# Growth rate vs nu
ax[0, 1].plot(nu_max/gamma_max, const_phiR_lam/gamma_max,  '-', lw=0.75, color=colors['primary_purple'])
ax[1, 1].plot(nu_max/gamma_max, max_gamma_lam/gamma_max, '-', lw=0.75, color=colors['primary_green'])
ax[2, 1].plot(nu_max/gamma_max, opt_allo_lam/gamma_max, '-', lw=0.75, color=colors['primary_blue'])

# PhiRr vs nu
ax[0, 0].plot(nu_max/gamma_max, phi_R_const * np.ones(len(nu_max)), '-', lw=0.75, color=colors['primary_purple'])
ax[1, 0].plot(nu_max/gamma_max, max_gamma_phi_R, '-', lw=0.75, color=colors['primary_green'])
ax[2, 0].plot(nu_max/gamma_max, opt_phi_R, '-', lw=0.75, color=colors['primary_blue'])

# Gamma vs nu
ax[0, 2].plot(nu_max/gamma_max, const_phiR_gamma/gamma_max, '-', lw=0.75, color=colors['primary_purple'])
ax[1, 2].plot(nu_max/gamma_max, np.ones(len(nu_max)), '-', lw=0.75, color=colors['primary_green'])
ax[2, 2].plot(nu_max/gamma_max, opt_allo_gamma/gamma_max, '-', lw=0.75, color=colors['primary_blue'])

plt.subplots_adjust(wspace=0.325, hspace=0.2)
plt.savefig('../../../figures/presentations/regulatory_scenarios_theory.pdf', bbox_inches='tight')
...
for i in range(3):
    ax[0].set_ylabel('$\phi_R$')
    ax[2].set_ylabel('$\gamma\, /\, \gamma_{max}$')
    ax[1].set_ylabel('$\lambda\, /\, \gamma_{max}$')
    ax[1].set_ylim([0, 0.3]) 
...
# Growth rate vs nu
ax[1].plot(nu_max/gamma_max, const_phiR_lam/gamma_max,  '-', lw=0.75, color=colors['primary_purple'])
ax[1].plot(nu_max/gamma_max, max_gamma_lam/gamma_max, '-', lw=0.75, color=colors['primary_green'])
ax[1].plot(nu_max/gamma_max, opt_allo_lam/gamma_max, '-', lw=0.75, color=colors['primary_blue'])

# PhiRr vs nu
ax[0].plot(nu_max/gamma_max, phi_R_const * np.ones(len(nu_max)), '-', lw=0.75, color=colors['primary_purple'])
ax[0].plot(nu_max/gamma_max, max_gamma_phi_R, '-', lw=0.75, color=colors['primary_green'])
ax[0].plot(nu_max/gamma_max, opt_phi_R, '-', lw=0.75, color=colors['primary_blue'])

# Gamma vs nu
ax[2].plot(nu_max/gamma_max, const_phiR_gamma/gamma_max, '-', lw=0.75, color=colors['primary_purple'])
ax[2].plot(nu_max/gamma_max, np.ones(len(nu_max)), '-', lw=0.75, color=colors['primary_green'])
ax[2].plot(nu_max/gamma_max, opt_allo_gamma/gamma_max, '-', lw=0.75, color=colors['primary_blue'])

plt.subplots_adjust(wspace=0.325, hspace=0.2)
plt.savefig('../../../figures/presentations/all_regulatory_scenarios_theory.pdf', bbox_inches='tight')
